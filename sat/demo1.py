...
def load_args():
    ...
    parser.add_argument('--k-hop', type=int, default=2, help="number of layers for GNNs default:2")
...
def train_epoch(model, A, criterion, optimizer, lr_scheduler, use_cuda=False):
    ...
    for epoch in range(args.epochs):
        ...
        print('==>>> epoch: {}, train loss: {:.6f},Time:{:.2f}'.format(epoch, loss, time.time() - time_epoch_start))
